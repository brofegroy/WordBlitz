                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: _SettingsScreenCupertinoSlider(
                          ...
                          sliderValueListenable: controller.blitzDurationListenable,
                          onValueChanged: controller.handleBlitzDurationSliderChanged,
                          onValueChangedEnd: controller.handleBlitzDurationSliderChangedEnd,
                          min: 10,
                          max: 180,
                          divisions: 17,
                        ),
                      ...
                      Container(
                        ...
                        child: _SettingsScreenOptionPicker(
                          ...
                          optionPickerValueListenable: controller.dropdown1ValueListenable,
                      ...
                      Container(
                        ...
                        child: _SettingsScreenOptionPicker(
                          ...
                          allocatedWidth: screenSize.width * 13/15,
                          allocatedHeight: 200,
                          description: "settingu two 1 with very long description ipsum lorem dolor sit amet ipsum lorem dolor sit amet ipsum lorem dolor sit amet ipsum lorem dolor sit amet ipsum lorem dolor sit amet ipsum lorem dolor sit amet ",
                          optionPickerValueListenable: controller.dropdown1ValueListenable,
                          optionPickerOnChanged: controller.handleDropdown1Changed,
                          optionPickerItems: ["item1","item2","item3","item4"],
                        ),
              ...
              builder: (context,currentValue,_) {
                return Container(
                  ...
                  child: DropdownButton(
                    isExpanded: true,
                    onChanged: (value){optionPickerOnChanged(value);},
                    items: optionPickerItems.map((item) =>
